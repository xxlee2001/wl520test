...
export default function html(pageInfo, content, state) {
	...
	const yyyScript = isDev ? '' : `<script src="${baseUrl}/javascripts/yonyou-yyy.js${random}"></script>`;
...
<html>
  <head>
    ...
    <link href="${baseUrl}/styles/tinper-bee.css" rel="stylesheet" type="text/css" />
    <link href="${baseUrl}/styles/antd.css" rel="stylesheet" type="text/css" />
    ${loadCss}
  </head>
  <body>
