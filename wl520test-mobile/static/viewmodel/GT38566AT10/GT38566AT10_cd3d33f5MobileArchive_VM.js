...
console.info('%c GT38566AT10_cd3d33f5MobileArchive_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
if (window && window.__debugger) debugger;
cb.viewmodels.register('GT38566AT10_cd3d33f5MobileArchive_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            'wenben': new cb.models.SimpleModel({
                ...
                "bMain": true,
                "cDataSourceName": "GT38566AT10.GT38566AT10.dignwiwe",
                "cControlType": "input",
                "bVmExclude": 0,
                "multiple": false,
                "iOrder": 0,
            ...
            'dingwei22': new cb.models.SimpleModel({
                "cFieldName": "dingwei22",
                "cItemName": "dingwei22",
                "cCaption": "定位22",
                "cShowCaption": "定位22",
                "iBillTplGroupId": 290667,
            ...
            'dingwei23': new cb.models.SimpleModel({
                "cFieldName": "dingwei23",
                "cItemName": "dingwei23",
                "cCaption": "定位23",
                "cShowCaption": "定位23",
                "iBillTplGroupId": 290667,
            ...
            'dingwei24': new cb.models.SimpleModel({
                "cFieldName": "dingwei24",
                "cItemName": "dingwei24",
                "cCaption": "定位24",
                "cShowCaption": "定位24",
                "iBillTplGroupId": 290667,
            ...
            'btnAddRow_1': new cb.models.SimpleModel({
                ...
                "iStyle": 0,
                "cCommand": "cmdAddRow",
                "childrenField": "dignweizitesList",
                "bVmExclude": 0,
                "iOrder": 0,
                "uncopyable": false,
                "bEnableFormat": false,
            ...
            'dignweizitesList': new cb.models.GridModel({
                "columns": {
                    "wenben": {
                        "cFieldName": "wenben",
                        "cItemName": "wenben",
                        ...
                        "bPrintUpCase": false,
                        "bSelfDefine": false,
                        "cTplGroupName": "定位子表啊啊啊",
                        "bMain": false,
                        "cDataSourceName": "GT38566AT10.GT38566AT10.dignweizites",
                        "cParentDataSource": "GT38566AT10.GT38566AT10.dignwiwe",
                        "cControlType": "input",
                        "bVmExclude": 0,
                        "multiple": false,
                        "iOrder": 0,
                    ...
                    "dignweizitesFk": {
                        "cFieldName": "dignweizitesFk",
                        "cItemName": "dignweizitesFk",
                        "cCaption": "外键",
                        "cShowCaption": "外键",
                        "iBillTplGroupId": 290673,
                        "iTplId": 12030,
        ...
        var girdModelKeys = ["dignweizitesList"]
        if (girdModelKeys) {
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT38566AT10'] && cb.biz['GT38566AT10']['GT38566AT10_cd3d33f5MobileArchive_VM_Extend']){
        //   console.info('%c GT38566AT10_cd3d33f5MobileArchive_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT38566AT10']['GT38566AT10_cd3d33f5MobileArchive_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT38566AT10/GT38566AT10_cd3d33f5MobileArchive_VM.Extend.js';
        cb.require('', [extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT38566AT10_cd3d33f5MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT38566AT10_cd3d33f5MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
