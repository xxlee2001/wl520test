...
console.info('%c GT16076AT470_152db540MobileArchive_VM js init', 'color:green');
cb.viewmodels.register('GT16076AT470_152db540MobileArchive_VM', function(modelType) {
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT16076AT470'] && cb.biz['GT16076AT470']['GT16076AT470_152db540MobileArchive_VM_Extend']){
        //   console.info('%c GT16076AT470_152db540MobileArchive_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT16076AT470']['GT16076AT470_152db540MobileArchive_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT16076AT470/GT16076AT470_152db540MobileArchive_VM.Extend.js';
        cb.require([extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT16076AT470_152db540MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT16076AT470_152db540MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
