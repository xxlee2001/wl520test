...
console.info('%c GT48061AT10_4baa6d13MobileArchive_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
if (window && window.__debugger) debugger;
cb.viewmodels.register('GT48061AT10_4baa6d13MobileArchive_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            '1606203409684_2': new cb.models.SimpleModel({
                "cFieldName": "",
                "fieldRuntimeState": false,
                "cItemName": "1606203409684_2",
                "cCaption": "人脸识别",
                "cShowCaption": "人脸识别",
                ...
                "bEnableFormat": false,
                "key": "Field235239",
                "cExtProps": "{\"cSubId\":\"\",\"_actions\":{\"onSuccess\":[{\"scriptId\":\"49e65c6293064cdf9e6e60f4504b1692\",\"action\":\"4baa6d13MobileArchive_1606203409684_2_onSuccess\",\"description\":\"前端函数\",\"type\":\"fun\",\"event\":\"onSuccess\"}]},\"color\":\"\",\"size\":\"md\",\"textAlign\":\"left\",\"showType\":\"text\",\"iconSize\":\"md\",\"showIcon\":\"icon-renlianshibie1\",\"url\":\"\",\"onSuccess\":\"1606203409684_2_onSuccess\"}",
                "cSubId": "",
                "_actions": {
                    "onSuccess": [{
                        "scriptId": "49e65c6293064cdf9e6e60f4504b1692",
                        "action": "4baa6d13MobileArchive_1606203409684_2_onSuccess",
                        "description": "前端函数",
                        "type": "fun",
                        "event": "onSuccess"
                    }]
                ...
                "showType": "text",
                "iconSize": "md",
                "showIcon": "icon-renlianshibie1",
                "url": "",
                "onSuccess": "1606203409684_2_onSuccess",
                "needClear": false
            }),
            ...
            'mActionList': new cb.models.SimpleModel({
                ...
                "x_evt_onSuccess": "1606203409684_2_onSuccess",
        ...
        _this.allActions = [{
            ...
            "cCommand": "1606203409684_2_onSuccess",
            "cAction": "1606203409684_2_onSuccess",
        ...
        _this.allEvents = [{
            "name": "1606203409684_2",
            "event": "success",
            "cAction": "1606203409684_2_onSuccess",
            "isCommandEvent": true,
            "params": "{\"cmdParameter\":\"{\\\"X_ISFUN\\\":\\\"true\\\",\\\"X_ISFRONT\\\":\\\"true\\\"}\",\"cCommand\":\"1606203409684_2_onSuccess\",\"cAction\":\"1606203409684_2_onSuccess\",\"cParameter\":\"{\\\"X_ISFUN\\\":\\\"true\\\",\\\"X_ISFRONT\\\":\\\"true\\\"}\",\"cFieldName\":\"\",\"fieldRuntimeState\":false,\"cItemName\":\"1606203409684_2\",\"cCaption\":\"人脸识别\",\"cShowCaption\":\"人脸识别\",\"iBillTplGroupId\":290667,\"iTplId\":13973,\"iFieldType\":1,\"bEnum\":false,\"bMustSelect\":true,\"bHidden\":false,\"bSplit\":false,\"bExtend\":false,\"bCanModify\":true,\"iMaxShowLen\":255,\"bNeedSum\":false,\"bShowIt\":true,\"bFilter\":true,\"bIsNull\":true,\"bPrintCaption\":true,\"bJointQuery\":false,\"bPrintUpCase\":false,\"bSelfDefine\":false,\"cTplGroupName\":\"Flex布局\",\"bMain\":true,\"cDataSourceName\":\"GT48061AT10.GT48061AT10.quanleixtst\",\"cControlType\":\"facerecognition\",\"bVmExclude\":0,\"iOrder\":10,\"iSystem\":1,\"authLevel\":3,\"isExport\":true,\"uncopyable\":false,\"iAlign\":1,\"bEnableFormat\":false,\"key\":\"Field235239\",\"cExtProps\":\"{\\\"cSubId\\\":\\\"\\\",\\\"_actions\\\":{\\\"onSuccess\\\":[{\\\"scriptId\\\":\\\"49e65c6293064cdf9e6e60f4504b1692\\\",\\\"action\\\":\\\"4baa6d13MobileArchive_1606203409684_2_onSuccess\\\",\\\"description\\\":\\\"前端函数\\\",\\\"type\\\":\\\"fun\\\",\\\"event\\\":\\\"onSuccess\\\"}]},\\\"color\\\":\\\"\\\",\\\"size\\\":\\\"md\\\",\\\"textAlign\\\":\\\"left\\\",\\\"showType\\\":\\\"text\\\",\\\"iconSize\\\":\\\"md\\\",\\\"showIcon\\\":\\\"icon-renlianshibie1\\\",\\\"url\\\":\\\"\\\",\\\"onSuccess\\\":\\\"1606203409684_2_onSuccess\\\"}\",\"cSubId\":\"\",\"_actions\":{\"onSuccess\":[{\"scriptId\":\"49e65c6293064cdf9e6e60f4504b1692\",\"action\":\"4baa6d13MobileArchive_1606203409684_2_onSuccess\",\"description\":\"前端函数\",\"type\":\"fun\",\"event\":\"onSuccess\"}]},\"color\":\"\",\"size\":\"md\",\"textAlign\":\"left\",\"showType\":\"text\",\"iconSize\":\"md\",\"showIcon\":\"icon-renlianshibie1\",\"url\":\"\",\"needClear\":false}",
            "needReduce": false
        }, {
            "name": "mActionList",
            "event": "fail",
        ...
        // standard event 1
        _this.get('1606203409684_2').on('success', function(params) {
            if (window && window.__debugger) {
                debugger;
            }
            console.info('%c*** AUTO GENERATE SCRIPT RUNNING : [1606203409684_2] execute Event[success] and do Action[1606203409684_2_onSuccess]', 'color:seagreen');
            let eventArgs = {
            ...
            return biz.do('1606203409684_2_onSuccess', _this, args); //standard event action
        });
        console.info('%c*** AUTO GENERATE SCRIPT ADDEVENTLISTNER : [1606203409684_2] addEventListner on [success] event and will do Acttion[1606203409684_2_onSuccess]!', 'color:teal');
        ...
        _this.get('mActionList').on('success', function(params) {
            ...
            console.info('%c*** AUTO GENERATE SCRIPT RUNNING : [mActionList] execute Event[success] and do Action[1606203409684_2_onSuccess]', 'color:seagreen');
            let eventArgs = {
                "eventUIMetaType": "commamdEvent"
            };
            var args = cb.utils.extend(true, eventArgs, {
        ...
        console.info('%c*** AUTO GENERATE SCRIPT ADDEVENTLISTNER : [mActionList] addEventListner on [success] event and will do Acttion[1606203409684_2_onSuccess]!', 'color:teal');
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT48061AT10'] && cb.biz['GT48061AT10']['GT48061AT10_4baa6d13MobileArchive_VM_Extend']){
        //   console.info('%c GT48061AT10_4baa6d13MobileArchive_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT48061AT10']['GT48061AT10_4baa6d13MobileArchive_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT48061AT10/GT48061AT10_4baa6d13MobileArchive_VM.Extend.js';
        cb.require('developplatform', [extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT48061AT10_4baa6d13MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT48061AT10_4baa6d13MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
