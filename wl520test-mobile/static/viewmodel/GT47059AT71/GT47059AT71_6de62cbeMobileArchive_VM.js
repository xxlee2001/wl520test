...
console.info('%c GT47059AT71_6de62cbeMobileArchive_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
if (window && window.__debugger) debugger;
cb.viewmodels.register('GT47059AT71_6de62cbeMobileArchive_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            'a0025_name': new cb.models.ReferModel({
                ...
                "bEnableFormat": false,
                "key": "Field226759",
                "cExtProps": "{\"isDeleted\":0,\"referConfig\":{\"cRefRetId\":\"{\\\"a0025\\\":\\\"id\\\"}\",\"displayName\":\"证书类型\",\"cRefType\":\"ucfbasedoc.0025\",\"refReturn\":\"name\"},\"disabled\":false,\"cSourceType\":\"\",\"placeholder\":\"\",\"singleLine\":true,\"canMultiple\":false}",
                "isDeleted": 0,
                "referConfig": {
                    "cRefRetId": "{\"a0025\":\"id\"}",
                    "displayName": "证书类型",
            ...
            'TaxRateVO_name': new cb.models.ReferModel({
                ...
                "bEnableFormat": false,
                "key": "Field226761",
                "cExtProps": "{\"isDeleted\":0,\"referConfig\":{\"cRefRetId\":\"{\\\"TaxRateVO\\\":\\\"id\\\"}\",\"displayName\":\"税目税率\",\"cRefType\":\"ucfbasedoc.bd_taxrate\",\"refReturn\":\"name\"},\"disabled\":false,\"cSourceType\":\"\",\"placeholder\":\"\",\"singleLine\":true,\"canMultiple\":false}",
                "isDeleted": 0,
                "referConfig": {
                    "cRefRetId": "{\"TaxRateVO\":\"id\"}",
                    "displayName": "税目税率",
            ...
            'addtype': new cb.models.ListModel({
                "cFieldName": "addtype",
                "fieldRuntimeState": false,
                "cItemName": "addtype",
                "cCaption": "加入类型",
            ...
            'ctrttype': new cb.models.ListModel({
                "cFieldName": "ctrttype",
                "fieldRuntimeState": false,
                "cItemName": "ctrttype",
                "cCaption": "合同期限类型",
            ...
            'new19': new cb.models.SimpleModel({
                "cFieldName": "new19",
                "fieldRuntimeState": false,
                "cItemName": "new19",
                "cCaption": "字段19",
            ...
            'new20': new cb.models.SimpleModel({
                "cFieldName": "new20",
                "fieldRuntimeState": false,
                "cItemName": "new20",
                "cCaption": "字段20",
            ...
            'a0025': new cb.models.SimpleModel({
                "cFieldName": "a0025",
                "fieldRuntimeState": false,
                "cItemName": "a0025",
                "cCaption": "证书类型id",
            ...
            'btnSubAbandon_1': new cb.models.SimpleModel({
                ...
                "bEnableFormat": false,
                "key": "494748",
                "cExtProps": "{\"mode\":\"toolbar-default\",\"_actions\":{\"onClick\":[{\"des\":\"关闭子页面\",\"action\":\"closePage\",\"type\":\"front\",\"event\":\"onClick\",\"params\":{\"cGroupCode\":\"ceszubiatetList\"}}]}}",
                "mode": "toolbar-default",
                "_actions": {
                    "onClick": [{
                        "des": "关闭子页面",
            ...
            'ceszubiatetList': new cb.models.GridModel({
                "columns": {
                    "wenben": {
                        "cFieldName": "wenben",
                        "fieldRuntimeState": false,
                        ...
                        "cTplGroupName": "测子表",
                        "bMain": false,
                        "cDataSourceName": "GT47059AT71.GT47059AT71.ceszubiatet",
                        "cParentDataSource": "GT47059AT71.GT47059AT71.cesliuss",
                        "cControlType": "input",
                        "bVmExclude": 0,
                        "multiple": false,
                        "iOrder": 500,
                    ...
                    "ceszubiatetFk": {
                        "cFieldName": "ceszubiatetFk",
                        "fieldRuntimeState": false,
                        "cItemName": "ceszubiatetFk",
                        "cCaption": "外键",
                        "cShowCaption": "外键",
                        "iBillTplGroupId": 290673,
                        "iTplId": 13699,
        ...
        var girdModelKeys = ["ceszubiatetList"]
        if (girdModelKeys) {
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT47059AT71'] && cb.biz['GT47059AT71']['GT47059AT71_6de62cbeMobileArchive_VM_Extend']){
        //   console.info('%c GT47059AT71_6de62cbeMobileArchive_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT47059AT71']['GT47059AT71_6de62cbeMobileArchive_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT47059AT71/GT47059AT71_6de62cbeMobileArchive_VM.Extend.js';
        cb.require('developplatform', [extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT47059AT71_6de62cbeMobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT47059AT71_6de62cbeMobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
