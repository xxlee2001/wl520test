...
console.info('%c GT39871AT24_e921cd84MobileArchive_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
if (window && window.__debugger) debugger;
cb.viewmodels.register('GT39871AT24_e921cd84MobileArchive_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            'wenben': new cb.models.SimpleModel({
                ...
                "bMain": true,
                "cDataSourceName": "GT39871AT24.GT39871AT24.shenpcestesta",
                "cControlType": "input",
                "bVmExclude": 0,
                "multiple": false,
                "iOrder": 0,
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT39871AT24'] && cb.biz['GT39871AT24']['GT39871AT24_e921cd84MobileArchive_VM_Extend']){
        //   console.info('%c GT39871AT24_e921cd84MobileArchive_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT39871AT24']['GT39871AT24_e921cd84MobileArchive_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT39871AT24/GT39871AT24_e921cd84MobileArchive_VM.Extend.js';
        cb.require('', [extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT39871AT24_e921cd84MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT39871AT24_e921cd84MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
