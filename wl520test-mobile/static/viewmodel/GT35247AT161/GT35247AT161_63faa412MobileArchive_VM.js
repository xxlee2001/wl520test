...
console.info('%c GT35247AT161_63faa412MobileArchive_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
if (window && window.__debugger) debugger;
cb.viewmodels.register('GT35247AT161_63faa412MobileArchive_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            'new1': new cb.models.SimpleModel({
                ...
                "iTplId": 1425,
                "iFunctionType": 0,
                "cDataSourceName": "GT35247AT161.GT35247AT161.sehnp001",
                "iMaxShowLen": 200,
                "isDeleted": 0,
                "bSplit": false,
                "bHidden": false,
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT35247AT161'] && cb.biz['GT35247AT161']['GT35247AT161_63faa412MobileArchive_VM_Extend']){
        //   console.info('%c GT35247AT161_63faa412MobileArchive_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT35247AT161']['GT35247AT161_63faa412MobileArchive_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT35247AT161/GT35247AT161_63faa412MobileArchive_VM.Extend.js';
        cb.require('', [extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT35247AT161_63faa412MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT35247AT161_63faa412MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
