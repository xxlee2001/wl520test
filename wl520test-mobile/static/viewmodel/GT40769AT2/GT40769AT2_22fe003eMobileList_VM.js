...
console.info('%c GT40769AT2_22fe003eMobileList_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
if (window && window.__debugger) debugger;
cb.viewmodels.register('GT40769AT2_22fe003eMobileList_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        _this.allActions = [{
            "cCommand": "1603177078120_38_onClick",
            "cAction": "1603177078120_38_onClick",
            ...
            "cCommand": "1603176462883_20_onClick",
            "cAction": "1603176462883_20_onClick",
            "cParameter": "{\"X_ISFUN\":\"true\",\"X_ISFRONT\":\"true\"}"
        }, {
            "cCommand": "1603176480617_23_onClick",
            "cAction": "1603176480617_23_onClick",
            "cParameter": "{\"X_ISFUN\":\"true\",\"X_ISFRONT\":\"true\"}"
        }, {
            "cCommand": "cmdEdit",
            "cAction": "edit",
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT40769AT2'] && cb.biz['GT40769AT2']['GT40769AT2_22fe003eMobileList_VM_Extend']){
        //   console.info('%c GT40769AT2_22fe003eMobileList_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT40769AT2']['GT40769AT2_22fe003eMobileList_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT40769AT2/GT40769AT2_22fe003eMobileList_VM.Extend.js';
        cb.require('snow', [extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT40769AT2_22fe003eMobileList_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT40769AT2_22fe003eMobileList_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
