...
console.info('%c GT40250AT29_0b002e2bMobileArchive_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
if (window && window.__debugger) debugger;
cb.viewmodels.register('GT40250AT29_0b002e2bMobileArchive_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            'btnSubAbandon_1': new cb.models.SimpleModel({
                ...
                "bEnableFormat": false,
                "key": "494748",
                "cExtProps": "{\"mode\":\"toolbar-default\",\"_actions\":{\"onClick\":[{\"des\":\"关闭子页面\",\"action\":\"closePage\",\"type\":\"front\",\"event\":\"onClick\",\"params\":{\"cGroupCode\":\"csdaaa1List\"}}]}}",
                "mode": "toolbar-default",
                "_actions": {
                    "onClick": [{
                        "des": "关闭子页面",
            ...
            'csdaaa1List': new cb.models.GridModel({
                "columns": {
                    "new1": {
                        "cFieldName": "new1",
                        "cItemName": "new1",
                        ...
                        "cTplGroupName": "Cesss",
                        "bMain": false,
                        "cDataSourceName": "GT40250AT29.GT40250AT29.csdaaa1",
                        "cParentDataSource": "GT40250AT29.GT40250AT29.atestaaa1",
                        "cControlType": "input",
                        "bVmExclude": 0,
                        "multiple": false,
                        "iOrder": 0,
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT40250AT29'] && cb.biz['GT40250AT29']['GT40250AT29_0b002e2bMobileArchive_VM_Extend']){
        //   console.info('%c GT40250AT29_0b002e2bMobileArchive_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT40250AT29']['GT40250AT29_0b002e2bMobileArchive_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT40250AT29/GT40250AT29_0b002e2bMobileArchive_VM.Extend.js';
        cb.require('developplatform', [extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT40250AT29_0b002e2bMobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT40250AT29_0b002e2bMobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
