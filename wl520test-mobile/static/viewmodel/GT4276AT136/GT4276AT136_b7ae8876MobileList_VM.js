...
console.info('%c GT4276AT136_b7ae8876MobileList_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
if (window && window.__debugger) debugger;
cb.viewmodels.register('GT4276AT136_b7ae8876MobileList_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            '1596088905961_2': new cb.models.SimpleModel({
                ...
                "bEnableFormat": false,
                "key": "Field8179",
                "cExtProps": "{\"cSubId\":\"GT4276AT136\",\"_actions\":{\"onClick\":[{\"des\":\"显示子页面\",\"action\":\"showPage\",\"type\":\"front\",\"event\":\"onClick\",\"params\":{\"cGroupCode\":\"1d905ad9101a64b45919c5be7e8e56c7b\"}}]},\"size\":\"md\",\"color\":\"#0d0c0c\",\"icon\":\"icon-shenfenshibie\",\"style\":{\"marginRight\":\"0.1rem\",\"marginLeft\":\"0.1rem\"}}",
                "cSubId": "GT4276AT136",
                "_actions": {
                    "onClick": [{
                        "des": "显示子页面",
            ...
            'new_main_001_1904905862123776': new cb.models.GridModel({
                "columns": {
                    "1596088905961_2": {
                        "cFieldName": "",
                        "cItemName": "1596088905961_2",
        ...
        if (billType == 'editvoucherlist') {
            var girdModelKeys = ["new_main_001_1904905862123776"]
            if (girdModelKeys) {
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT4276AT136'] && cb.biz['GT4276AT136']['GT4276AT136_b7ae8876MobileList_VM_Extend']){
        //   console.info('%c GT4276AT136_b7ae8876MobileList_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT4276AT136']['GT4276AT136_b7ae8876MobileList_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT4276AT136/GT4276AT136_b7ae8876MobileList_VM.Extend.js';
        cb.require('developplatform', [extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT4276AT136_b7ae8876MobileList_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT4276AT136_b7ae8876MobileList_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
