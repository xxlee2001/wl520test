...
console.info('%c GT4276AT136_b7ae8876MobileArchive_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
if (window && window.__debugger) debugger;
cb.viewmodels.register('GT4276AT136_b7ae8876MobileArchive_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            'tenant_id': new cb.models.SimpleModel({
                ...
                "bEnableFormat": false,
                "key": "Field165226",
                "cExtProps": "{\"cSubId\":\"\",\"subuitype\":\"text\",\"replaceChart\":\"#\",\"regRule\":\"\",\"showExtraLabelIcon\":false,\"subLabel\":\"\",\"defaultValue\":\"\",\"formatReg\":\"\",\"regRuleText\":\"\",\"checkMask\":\"\",\"check\":false,\"singleLine\":true,\"hiddenChart\":\"*\",\"singleLineCenter\":false,\"metaDataField\":{\"biztype\":\"text\",\"fieldName\":\"tenant_id\",\"terms\":[{\"code\":\"uiHide\",\"name\":\"模版隐藏\",\"id\":\"1a467f8a-cb3c-44da-819f-3916bc89f2a4\"}],\"displayName\":\"租户id\",\"dataType\":{\"name\":\"友互通用户租户\",\"metaType\":\"Class\",\"id\":\"ec9cb2fe-b176-4a1d-8db8-ac8188b468a9\",\"uri\":\"basedoc.yht.PubUserTenant\"},\"name\":\"tenant_id\"},\"splitLine\":true,\"disabled\":false,\"placeholder\":\"请输入\",\"maxLength\":\"\"}",
                "cSubId": "",
                "subuitype": "text",
                "replaceChart": "#",
                "regRule": "",
                ...
                "metaDataField": {
                    ...
                    "terms": [{
                        "code": "uiHide",
                        "name": "模版隐藏",
                        "id": "1a467f8a-cb3c-44da-819f-3916bc89f2a4"
                    }],
                    "displayName": "租户id",
                    "dataType": {
                        "name": "友互通用户租户",
                        "metaType": "Class",
                        "id": "ec9cb2fe-b176-4a1d-8db8-ac8188b468a9",
                        "uri": "basedoc.yht.PubUserTenant"
                    },
                    "name": "tenant_id"
                },
                "splitLine": true,
            ...
            '1600152467402_2': new cb.models.SimpleModel({
                "cFieldName": "",
                "cItemName": "1600152467402_2",
                "cCaption": "图标",
                "cShowCaption": "图标",
                "iBillTplGroupId": 290667,
                "iTplId": 11609,
                ...
                "bEnableFormat": false,
                "key": "Field163543",
                "cExtProps": "{\"cSubId\":\"\",\"color\":\"\",\"size\":\"md\",\"icon\":\"check-circle\"}",
                "cSubId": "",
                "color": "",
                "size": "md",
                "icon": "check-circle",
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT4276AT136'] && cb.biz['GT4276AT136']['GT4276AT136_b7ae8876MobileArchive_VM_Extend']){
        //   console.info('%c GT4276AT136_b7ae8876MobileArchive_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT4276AT136']['GT4276AT136_b7ae8876MobileArchive_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT4276AT136/GT4276AT136_b7ae8876MobileArchive_VM.Extend.js';
        cb.require('developplatform', [extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT4276AT136_b7ae8876MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT4276AT136_b7ae8876MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
