...
console.info('%c GT4276AT136_36294f04MobileArchive_VM js init', 'color:green');
cb.viewmodels.register('GT4276AT136_36294f04MobileArchive_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            'btnAddRowtest_09122': new cb.models.SimpleModel({
                "mode": "ghost",
                "bVmExclude": 0,
                "cCommand": "cmdAddRow",
                "bEnableFormat": false,
                "cControlType": "button",
                "cItemName": "btnAddRowtest_09122",
                "iStyle": 0,
                "uncopyable": false,
                "cCaption": "增加字表",
                "iOrder": 0,
            ...
            'btnSubAbandon': new cb.models.SimpleModel({
                "bVmExclude": 0,
                "cCommand": "cmdSubAbandon",
                "bEnableFormat": false,
                "cControlType": "button",
                "cItemName": "btnSubAbandon",
                "iStyle": 0,
                "uncopyable": false,
                "cCaption": "取消",
                "iOrder": 0,
            ...
            'btnSubSave': new cb.models.SimpleModel({
                "mode": "toolbar-default",
                "bVmExclude": 0,
                "cCommand": "",
                "bEnableFormat": false,
                "cControlType": "button",
                "cItemName": "btnSubSave",
                "iStyle": 0,
                "uncopyable": false,
                "cCaption": "确定",
                "iOrder": 0,
        ...
        _this.get('btnAddRowtest_09122').on('click', function(params) {
            var args = cb.utils.extend(true, {}, {
                "cCommand": "cmdAddRow",
                "cAction": "addrow",
                "mode": "ghost",
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT4276AT136'] && cb.biz['GT4276AT136']['GT4276AT136_36294f04MobileArchive_VM_Extend']){
        //   console.info('%c GT4276AT136_36294f04MobileArchive_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT4276AT136']['GT4276AT136_36294f04MobileArchive_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT4276AT136/GT4276AT136_36294f04MobileArchive_VM.Extend.js';
        cb.require([extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT4276AT136_36294f04MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT4276AT136_36294f04MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
