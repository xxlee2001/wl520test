...
console.info('%c GT4276AT136_1d8b98eeMobileList_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
if (window && window.__debugger) debugger;
cb.viewmodels.register('GT4276AT136_1d8b98eeMobileList_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            'mSearch': new cb.models.SimpleModel({
                ...
                "bEnableFormat": false,
                "key": "Field6663",
                "cExtProps": "{\"cSubId\":\"GT4276AT136\",\"controlled\":false,\"_actions\":{\"onSubmit\":[{\"action\":\"cmdSearch\",\"type\":\"command\",\"event\":\"onSubmit\"}]},\"onScan\":\"mSearch_onScan\",\"defaultValue\":\"\",\"disabled\":\"\",\"term\":\"\",\"placeholder\":\"编码/名称/型号规格/助记...\",\"value\":\"\",\"maxLength\":\"\"}",
                "cSubId": "GT4276AT136",
                "controlled": false,
                "_actions": {
                    "onSubmit": [{
            ...
            'zhuwenben': new cb.models.SimpleModel({
                ...
                "bEnableFormat": false,
                "key": "Field53583",
                "cExtProps": "{\"_actions\":{\"onFocus\":[{\"action\":\"cmdBatchDelete\",\"type\":\"command\",\"event\":\"onFocus\"}]},\"isDeleted\":0,\"disabled\":true,\"cSourceType\":\"\",\"placeholder\":\"\",\"singleLine\":true,\"canMultiple\":false}",
                "_actions": {
                    "onFocus": [{
            ...
            'new_main_001_1886765308694784': new cb.models.GridModel({
                "columns": {
                    "1596088905961_2": {
                        "cFieldName": "",
                        "fieldRuntimeState": false,
                    ...
                    "1595474082716_8": {
                        ...
                        "bEnableFormat": false,
                        "key": "Field6528",
                        "cExtProps": "{\"cSubId\":\"GT4276AT136\",\"color\":\"#f70707\",\"size\":\"md\",\"icon\":\"icon-file-o\",\"style\":{\"backgroundColor\":\"hsl(0, 66%, 89.6%)\",\"backgroundImage\":\"\",\"backgroundStatate\":\"color\",\"width\":\"0.4rem\",\"height\":\"0.4rem\"}}",
                        "cSubId": "GT4276AT136",
                        "color": "#f70707",
                        "size": "md",
                        "icon": "icon-file-o",
            ...
            'mActionList': new cb.models.SimpleModel({
                ...
                "enterDirection": 4,
                "bEnableFormat": false,
                "cExtProps": "{\"onScan\":\"mSearch_onScan\",\"onSubmit\":\"1595556507535_2_onSubmit\",\"uncopyable\":0}",
                "uncopyable": 0,
        ...
        if (billType == 'editvoucherlist') {
            var girdModelKeys = ["new_main_001_1886765308694784"]
            if (girdModelKeys) {
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT4276AT136'] && cb.biz['GT4276AT136']['GT4276AT136_1d8b98eeMobileList_VM_Extend']){
        //   console.info('%c GT4276AT136_1d8b98eeMobileList_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT4276AT136']['GT4276AT136_1d8b98eeMobileList_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT4276AT136/GT4276AT136_1d8b98eeMobileList_VM.Extend.js';
        cb.require('developplatform', [extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT4276AT136_1d8b98eeMobileList_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT4276AT136_1d8b98eeMobileList_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
