...
console.info('%c GT4276AT136_aa48f557MobileArchive_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
if (window && window.__debugger) debugger;
cb.viewmodels.register('GT4276AT136_aa48f557MobileArchive_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            'zhuwenben': new cb.models.SimpleModel({
                ...
                "bEnableFormat": false,
                "key": "Field14149",
                "cExtProps": "{\"placeholder\":\"\",\"singleLine\":true}",
                "placeholder": "",
                "singleLine": true
            }),
            ...
            'createTime': new cb.models.SimpleModel({
            ...
            'modifyTime': new cb.models.SimpleModel({
            ...
            'creator.userName': new cb.models.SimpleModel({
            ...
            'modifier.userName': new cb.models.SimpleModel({
            ...
            'btnAddRow新子实体01': new cb.models.SimpleModel({
                "fieldRuntimeState": false,
                "cItemName": "btnAddRow新子实体01",
                "cCaption": "增加字表",
                "cShowCaption": "增加字表",
                "bEnum": false,
                "cControlType": "button",
            ...
            'btnSubAbandon新子实体01': new cb.models.SimpleModel({
                "fieldRuntimeState": false,
                "cItemName": "btnSubAbandon新子实体01",
                "cCaption": "取消",
                "cShowCaption": "取消",
                "bEnum": false,
                "cControlType": "button",
                ...
                "bEnableFormat": false,
                "key": "494748",
                "cExtProps": "{\"_actions\":{\"onClick\":[{\"des\":\"关闭子页面\",\"action\":\"closePage\",\"type\":\"front\",\"event\":\"onClick\",\"params\":{\"cGroupCode\":\"new_child_001List\"}}]}}",
                "_actions": {
                    "onClick": [{
                        "des": "关闭子页面",
                        "action": "closePage",
            ...
            'btnSubSave新子实体01': new cb.models.SimpleModel({
                "fieldRuntimeState": false,
                "cItemName": "btnSubSave新子实体01",
                "cCaption": "确定",
                "cShowCaption": "确定",
                "bEnum": false,
                "cControlType": "button",
                ...
                "bEnableFormat": false,
                "key": "494750",
                "cExtProps": "{\"mode\":\"toolbar-default\",\"_actions\":{\"onClick\":[{\"des\":\"关闭子页面\",\"action\":\"closePage\",\"type\":\"front\",\"event\":\"onClick\",\"params\":{}}]}}",
                "mode": "toolbar-default",
                "_actions": {
                    "onClick": [{
                        "des": "关闭子页面",
            ...
            'mActionList': new cb.models.SimpleModel({
                ...
                "enterDirection": 4,
                "bEnableFormat": false,
                "cExtProps": "{\"onFail\":\"1595918997321_2_onFail\",\"uncopyable\":0,\"onSuccess\":\"1595916323036_2_onSuccess\"}",
                "uncopyable": 0,
        ...
        _this.get('btnAddRow新子实体01').on('click', function(params) {
            var args = cb.utils.extend(true, {}, {
                "cCommand": "cmdAddRow",
                "cAction": "addrow",
                "childrenField": "new_child_001List",
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT4276AT136'] && cb.biz['GT4276AT136']['GT4276AT136_aa48f557MobileArchive_VM_Extend']){
        //   console.info('%c GT4276AT136_aa48f557MobileArchive_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT4276AT136']['GT4276AT136_aa48f557MobileArchive_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT4276AT136/GT4276AT136_aa48f557MobileArchive_VM.Extend.js';
        cb.require('developplatform', [extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT4276AT136_aa48f557MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT4276AT136_aa48f557MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
