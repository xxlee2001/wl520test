...
console.info('%c GT50880AT22_b95e79e5MobileArchive_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
if (window && window.__debugger) debugger;
cb.viewmodels.register('GT50880AT22_b95e79e5MobileArchive_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            'new9': new cb.models.SimpleModel({
                "cFieldName": "new9",
                "fieldRuntimeState": false,
                "cItemName": "new9",
                "cCaption": "字段9",
            ...
            'new10': new cb.models.SimpleModel({
                "cFieldName": "new10",
                "fieldRuntimeState": false,
                "cItemName": "new10",
                "cCaption": "字段10",
            ...
            'new13': new cb.models.SimpleModel({
                "cFieldName": "new13",
                "fieldRuntimeState": false,
                "cItemName": "new13",
                "cCaption": "字段13",
            ...
            'new14': new cb.models.SimpleModel({
                "cFieldName": "new14",
                "fieldRuntimeState": false,
                "cItemName": "new14",
                "cCaption": "字段14",
            ...
            'new18': new cb.models.SimpleModel({
                "cFieldName": "new18",
                "fieldRuntimeState": false,
                "cItemName": "new18",
                "cCaption": "字段18",
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT50880AT22'] && cb.biz['GT50880AT22']['GT50880AT22_b95e79e5MobileArchive_VM_Extend']){
        //   console.info('%c GT50880AT22_b95e79e5MobileArchive_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT50880AT22']['GT50880AT22_b95e79e5MobileArchive_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT50880AT22/GT50880AT22_b95e79e5MobileArchive_VM.Extend.js';
        cb.require('developplatform', [extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT50880AT22_b95e79e5MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT50880AT22_b95e79e5MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
