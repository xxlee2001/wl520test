...
console.info('%c GT39966AT27_01cbf7caMobileList_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
if (window && window.__debugger) debugger;
cb.viewmodels.register('GT39966AT27_01cbf7caMobileList_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            '1596088905961_2': new cb.models.SimpleModel({
                ...
                "bMain": true,
                "cDataSourceName": "GT39966AT27.GT39966AT27.meitest1",
                "cControlType": "icon",
                "bVmExclude": 0,
                "iOrder": 0,
                "iSystem": 1,
            ...
            'meitest1_1928563580997888': new cb.models.GridModel({
                "columns": {
                    "1596088905961_2": {
                        "cFieldName": "",
                        "cItemName": "1596088905961_2",
                    ...
                    "sys_action": {
                        "cFieldName": "sys_action",
                        "cItemName": "sys_action",
                        "cCaption": "单据状态枚举",
                        "cShowCaption": "单据状态枚举",
                        "iBillTplGroupId": 290688,
                        "iTplId": 12022,
                    ...
                    "sys_verifystate": {
                        "cFieldName": "sys_verifystate",
                        "cItemName": "sys_verifystate",
                        "cCaption": "审批状态枚举",
                        "cShowCaption": "审批状态枚举",
                        "iBillTplGroupId": 290688,
                        "iTplId": 12022,
                    ...
                    "meijutest1": {
                        "cFieldName": "meijutest1",
                        "cItemName": "meijutest1",
                        "cCaption": "枚举0922test2",
                        "cShowCaption": "枚举0922test2",
                        "iBillTplGroupId": 290688,
                        "iTplId": 12022,
                        "iMaxLength": 200,
                        "iFieldType": 1,
                        "bEnum": true,
                        "cEnumType": "meijutest1",
                        "bMustSelect": true,
                        "bHidden": false,
                        "iFunctionType": 0,
                        "bSplit": false,
        ...
        if (billType == 'editvoucherlist') {
            var girdModelKeys = ["meitest1_1928563580997888"]
            if (girdModelKeys) {
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT39966AT27'] && cb.biz['GT39966AT27']['GT39966AT27_01cbf7caMobileList_VM_Extend']){
        //   console.info('%c GT39966AT27_01cbf7caMobileList_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT39966AT27']['GT39966AT27_01cbf7caMobileList_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT39966AT27/GT39966AT27_01cbf7caMobileList_VM.Extend.js';
        cb.require('', [extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT39966AT27_01cbf7caMobileList_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT39966AT27_01cbf7caMobileList_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
