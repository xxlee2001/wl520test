...
console.info('%c GT39966AT27_01cbf7caMobileArchive_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
if (window && window.__debugger) debugger;
cb.viewmodels.register('GT39966AT27_01cbf7caMobileArchive_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            'sys_action': new cb.models.ListModel({
            ...
            'aatestaaList': new cb.models.GridModel({
                "columns": {
                    "test0924": {
                        "cFieldName": "test0924",
                        "cItemName": "test0924",
                        ...
                        "bPrintUpCase": false,
                        "bSelfDefine": false,
                        "cTplGroupName": "枚举子表test",
                        "bMain": false,
                        "cDataSourceName": "GT39966AT27.GT39966AT27.aatestaa",
                        "cParentDataSource": "GT39966AT27.GT39966AT27.meitest1",
                        "cControlType": "optionwidget",
                        "bVmExclude": 0,
                        "multiple": false,
                        "iOrder": 0,
                    ...
                    "aatestaaFk": {
                        "cFieldName": "aatestaaFk",
                        "cItemName": "aatestaaFk",
                        "cCaption": "外键",
                        "cShowCaption": "外键",
                        "iBillTplGroupId": 290673,
                        "iTplId": 12021,
        ...
        var girdModelKeys = ["aatestaaList"]
        if (girdModelKeys) {
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT39966AT27'] && cb.biz['GT39966AT27']['GT39966AT27_01cbf7caMobileArchive_VM_Extend']){
        //   console.info('%c GT39966AT27_01cbf7caMobileArchive_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT39966AT27']['GT39966AT27_01cbf7caMobileArchive_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT39966AT27/GT39966AT27_01cbf7caMobileArchive_VM.Extend.js';
        cb.require('', [extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT39966AT27_01cbf7caMobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT39966AT27_01cbf7caMobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
