...
console.info('%c GT39423AT19_211ac13aMobileArchive_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
if (window && window.__debugger) debugger;
cb.viewmodels.register('GT39423AT19_211ac13aMobileArchive_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            'StaffNew_name': new cb.models.ReferModel({
                ...
                "bEnableFormat": false,
                "key": "Field169191",
                "cExtProps": "{\"isDeleted\":0,\"referConfig\":{\"cRefRetId\":\"{\\\"StaffNew\\\":\\\"id\\\"}\",\"displayName\":\"员工\",\"cRefType\":\"ucf-staff-center.bd_staff_ref\",\"refReturn\":\"name\"},\"disabled\":false,\"cSourceType\":\"\",\"placeholder\":\"\",\"singleLine\":true,\"canMultiple\":false}",
                "isDeleted": 0,
                "referConfig": {
                    "cRefRetId": "{\"StaffNew\":\"id\"}",
                    "displayName": "员工",
            ...
            'chuxingfnag': new cb.models.ListModel({
            ...
            'baoxiaojine': new cb.models.SimpleModel({
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT39423AT19'] && cb.biz['GT39423AT19']['GT39423AT19_211ac13aMobileArchive_VM_Extend']){
        //   console.info('%c GT39423AT19_211ac13aMobileArchive_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT39423AT19']['GT39423AT19_211ac13aMobileArchive_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT39423AT19/GT39423AT19_211ac13aMobileArchive_VM.Extend.js';
        cb.require('developplatform', [extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT39423AT19_211ac13aMobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT39423AT19_211ac13aMobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
