...
console.info('%c GT39423AT19_e9480084MobileArchive_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
if (window && window.__debugger) debugger;
cb.viewmodels.register('GT39423AT19_e9480084MobileArchive_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            'lvdian': new cb.models.SimpleModel({
                "cFieldName": "lvdian",
                "cItemName": "lvdian",
                "cCaption": "旅店",
                "cShowCaption": "旅店",
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT39423AT19'] && cb.biz['GT39423AT19']['GT39423AT19_e9480084MobileArchive_VM_Extend']){
        //   console.info('%c GT39423AT19_e9480084MobileArchive_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT39423AT19']['GT39423AT19_e9480084MobileArchive_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT39423AT19/GT39423AT19_e9480084MobileArchive_VM.Extend.js';
        cb.require('developplatform', [extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT39423AT19_e9480084MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT39423AT19_e9480084MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
