...
console.info('%c GT37461AT1_0fd243fbMobileList_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
if (window && window.__debugger) debugger;
cb.viewmodels.register('GT37461AT1_0fd243fbMobileList_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            'yemianhahsutest_1905961565671680': new cb.models.GridModel({
                "columns": {
                    "1596088905961_2": {
                        "cFieldName": "",
                        "cItemName": "1596088905961_2",
            ...
            'mActionList': new cb.models.SimpleModel({
                ...
                "x_evt_onShow": "1595488808715_5_onShow",
        ...
        _this.allActions = [{
            "cCommand": "1595488808715_5_onShow",
            "cAction": "1595488808715_5_onShow",
        ...
        _this.allEvents = [{
            ...
            "params": "{\"cFieldName\":\"\",\"cItemName\":\"mSearch\",\"cCaption\":\"搜索\",\"cShowCaption\":\"搜索\",\"iBillTplGroupId\":10362,\"iTplId\":11624,\"iFieldType\":1,\"bEnum\":false,\"bMustSelect\":true,\"bHidden\":false,\"bSplit\":false,\"bExtend\":false,\"bCanModify\":true,\"iMaxShowLen\":255,\"bNeedSum\":false,\"bShowIt\":true,\"bFilter\":true,\"bIsNull\":true,\"bPrintCaption\":true,\"bJointQuery\":false,\"bPrintUpCase\":false,\"bSelfDefine\":false,\"cTplGroupName\":\"流式布局\",\"bMain\":true,\"cDataSourceName\":\"GT37461AT1.GT37461AT1.yemianhahsutest\",\"cControlType\":\"search\",\"bVmExclude\":0,\"iOrder\":0,\"iSystem\":1,\"authLevel\":3,\"isExport\":true,\"uncopyable\":false,\"iAlign\":1,\"bEnableFormat\":false,\"key\":\"Field6663\",\"cSubId\":\"GT37461AT1\",\"controlled\":false,\"_actions\":{\"onSubmit\":[{\"action\":\"cmdSearch\",\"type\":\"command\",\"event\":\"onSubmit\"}]},\"defaultValue\":\"\",\"disabled\":\"\",\"term\":\"\",\"placeholder\":\"编码/名称/型号规格/助记...\",\"value\":\"\",\"maxLength\":\"\",\"needClear\":false}",
            "needReduce": false
        }];
        ...
        if (billType == 'editvoucherlist') {
            var girdModelKeys = ["yemianhahsutest_1905961565671680"]
            if (girdModelKeys) {
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT37461AT1'] && cb.biz['GT37461AT1']['GT37461AT1_0fd243fbMobileList_VM_Extend']){
        //   console.info('%c GT37461AT1_0fd243fbMobileList_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT37461AT1']['GT37461AT1_0fd243fbMobileList_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT37461AT1/GT37461AT1_0fd243fbMobileList_VM.Extend.js';
        cb.require('', [extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT37461AT1_0fd243fbMobileList_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT37461AT1_0fd243fbMobileList_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
