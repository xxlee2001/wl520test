...
console.info('%c GT40110AT28_0189340bMobileArchive_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
if (window && window.__debugger) debugger;
cb.viewmodels.register('GT40110AT28_0189340bMobileArchive_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            '1601275027451_2': new cb.models.SimpleModel({
                "cFieldName": "",
                "cItemName": "1601275027451_2",
                "cCaption": "标签",
                "cShowCaption": "标签",
                ...
                "bEnableFormat": false,
                "key": "Field176540",
                "cExtProps": "{\"cSubId\":\"\",\"rightIcon\":\"\",\"textAlign\":\"left\",\"leftIcon\":\"\",\"textClamp\":0,\"textLangth\":0}",
                "cSubId": "",
                "rightIcon": "",
                "textAlign": "left",
                "leftIcon": "",
            ...
            '1601275033294_5': new cb.models.SimpleModel({
                "cFieldName": "",
                "cItemName": "1601275033294_5",
                "cCaption": "标签",
                "cShowCaption": "标签",
                "iBillTplGroupId": 290667,
                "iTplId": 12047,
            ...
            'ziduan4': new cb.models.SimpleModel({
                "cFieldName": "ziduan4",
                "cItemName": "ziduan4",
                "cCaption": "手机",
                "cShowCaption": "手机",
            ...
            'zhengjianhao1': new cb.models.SimpleModel({
            ...
            'compareLogic': new cb.models.ListModel({
                ...
                "bEnableFormat": false,
                "key": "Field173489",
                "cExtProps": "{\"isDeleted\":0,\"BASEURL\":\"https://build.yyuap.com/iuap-front\",\"disabled\":false,\"cSourceType\":\"\",\"placeholder\":\"\",\"singleLine\":true,\"canMultiple\":true}",
                "isDeleted": 0,
            ...
            'CurrencyTenantVO_name': new cb.models.ReferModel({
                ...
                "bEnableFormat": false,
                "key": "Field173493",
                "cExtProps": "{\"isDeleted\":0,\"referConfig\":{\"cRefRetId\":\"{\\\"CurrencyTenantVO\\\":\\\"id\\\"}\",\"displayName\":\"币种\",\"cRefType\":\"ucfbasedoc.bd_currencytenantref\",\"refReturn\":\"name\"},\"disabled\":false,\"cSourceType\":\"\",\"placeholder\":\"\",\"singleLine\":true,\"canMultiple\":false}",
                "isDeleted": 0,
                "referConfig": {
                    "cRefRetId": "{\"CurrencyTenantVO\":\"id\"}",
                    "displayName": "币种",
            ...
            'zuzhidanyuan_name': new cb.models.ReferModel({
                ...
                "bEnableFormat": false,
                "key": "Field173494",
                "cExtProps": "{\"isDeleted\":0,\"referConfig\":{\"cRefRetId\":\"{\\\"zuzhidanyuan\\\":\\\"id\\\"}\",\"displayName\":\"组织单元\",\"cRefType\":\"ucf-org-center.org_unit_tree_ref\",\"refReturn\":\"name\"},\"disabled\":false,\"cSourceType\":\"\",\"placeholder\":\"\",\"singleLine\":true,\"canMultiple\":false}",
                "isDeleted": 0,
                "referConfig": {
                    "cRefRetId": "{\"zuzhidanyuan\":\"id\"}",
                    "displayName": "组织单元",
            ...
            'liandong': new cb.models.SimpleModel({
                "cFieldName": "liandong",
                "cItemName": "liandong",
                "cCaption": "联动",
                "cShowCaption": "联动",
            ...
            'xingbie': new cb.models.ListModel({
                "cFieldName": "xingbie",
                "cItemName": "xingbie",
                "cCaption": "性别",
                "cShowCaption": "性别",
            ...
            'aihhao': new cb.models.ListModel({
                "cFieldName": "aihhao",
                "cItemName": "aihhao",
                "cCaption": "爱好",
                "cShowCaption": "爱好",
            ...
            'biaocanz01_name': new cb.models.ReferModel({
                ...
                "bEnableFormat": false,
                "key": "Field173499",
                "cExtProps": "{\"isDeleted\":0,\"referConfig\":{\"cRefRetId\":\"{\\\"biaocanz01\\\":\\\"id\\\"}\",\"displayName\":\"表参照\",\"cRefType\":\"developplatform.RefTable_f9af4da24\",\"refReturn\":\"name\"},\"disabled\":false,\"cSourceType\":\"\",\"placeholder\":\"\",\"singleLine\":true,\"canMultiple\":false}",
                "isDeleted": 0,
                "referConfig": {
                    "cRefRetId": "{\"biaocanz01\":\"id\"}",
                    "displayName": "表参照",
            ...
            'dawenben1': new cb.models.SimpleModel({
            ...
            'zuzhidanyuan': new cb.models.SimpleModel({
            ...
            'biaocanz01': new cb.models.SimpleModel({
            ...
            'btnSubAbandon_1': new cb.models.SimpleModel({
                ...
                "bEnableFormat": false,
                "key": "494748",
                "cExtProps": "{\"mode\":\"toolbar-default\",\"_actions\":{\"onClick\":[{\"des\":\"关闭子页面\",\"action\":\"closePage\",\"type\":\"front\",\"event\":\"onClick\",\"params\":{\"cGroupCode\":\"zatestaa1List\"}}]}}",
                "mode": "toolbar-default",
                "_actions": {
                    "onClick": [{
                        "des": "关闭子页面",
            ...
            'zatestaa1List': new cb.models.GridModel({
                "columns": {
                    "wenben": {
                        "cFieldName": "wenben",
                        "cItemName": "wenben",
                        ...
                        "bPrintUpCase": false,
                        "bSelfDefine": false,
                        "cTplGroupName": "子表testa1",
                        "bMain": false,
                        "cDataSourceName": "GT40110AT28.GT40110AT28.zatestaa1",
                        "cParentDataSource": "GT40110AT28.GT40110AT28.tester0924",
                        "cControlType": "input",
                        "bVmExclude": 0,
                        "multiple": false,
                        "iOrder": 0,
                    ...
                    "zatestaa1Fk": {
                        "cFieldName": "zatestaa1Fk",
                        "cItemName": "zatestaa1Fk",
                        "cCaption": "外键",
                        "cShowCaption": "外键",
                        "iBillTplGroupId": 290673,
                        "iTplId": 12047,
        ...
        var girdModelKeys = ["zatestaa1List"]
        if (girdModelKeys) {
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT40110AT28'] && cb.biz['GT40110AT28']['GT40110AT28_0189340bMobileArchive_VM_Extend']){
        //   console.info('%c GT40110AT28_0189340bMobileArchive_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT40110AT28']['GT40110AT28_0189340bMobileArchive_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT40110AT28/GT40110AT28_0189340bMobileArchive_VM.Extend.js';
        cb.require('developplatform', [extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT40110AT28_0189340bMobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT40110AT28_0189340bMobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
