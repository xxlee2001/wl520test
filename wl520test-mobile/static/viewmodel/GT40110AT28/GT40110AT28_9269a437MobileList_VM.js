...
console.info('%c GT40110AT28_9269a437MobileList_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
if (window && window.__debugger) debugger;
cb.viewmodels.register('GT40110AT28_9269a437MobileList_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            'tester0924_1928948274417920': new cb.models.GridModel({
                "columns": {
                    "1596088905961_2": {
                        "cFieldName": "",
                        "cItemName": "1596088905961_2",
                    ...
                    "1600935409728_8": {
                        "cFieldName": "",
                        "cItemName": "1600935409728_8",
                        "cCaption": "不转阿航不转阿航不转阿航不转阿航不转阿航不转阿航不转阿航",
                        "cShowCaption": "不转阿航不转阿航不转阿航不转阿航不转阿航不转阿航不转阿航",
                        "iBillTplGroupId": 290688,
                        "iTplId": 12044,
                        "iFieldType": 1,
                        "bEnum": false,
                    ...
                    "1600935439076_11": {
                        "cFieldName": "",
                        "cItemName": "1600935439076_11",
                        "cCaption": "不转阿航不转阿航不转阿航",
                        "cShowCaption": "不转阿航不转阿航不转阿航",
                        "iBillTplGroupId": 290688,
                        "iTplId": 12044,
                        "iFieldType": 1,
                        "bEnum": false,
        ...
        _this.allEvents = [{
            ...
            "params": "{\"cFieldName\":\"\",\"cItemName\":\"mSearch\",\"cCaption\":\"搜索\",\"cShowCaption\":\"搜索\",\"iBillTplGroupId\":10362,\"iTplId\":12044,\"iFieldType\":1,\"bEnum\":false,\"bMustSelect\":true,\"bHidden\":false,\"bSplit\":false,\"bExtend\":false,\"bCanModify\":true,\"iMaxShowLen\":255,\"bNeedSum\":false,\"bShowIt\":true,\"bFilter\":true,\"bIsNull\":true,\"bPrintCaption\":true,\"bJointQuery\":false,\"bPrintUpCase\":false,\"bSelfDefine\":false,\"cTplGroupName\":\"流式布局\",\"bMain\":true,\"cDataSourceName\":\"GT40110AT28.GT40110AT28.tester0924\",\"cControlType\":\"search\",\"bVmExclude\":0,\"iOrder\":0,\"iSystem\":1,\"authLevel\":3,\"isExport\":true,\"uncopyable\":false,\"iAlign\":1,\"bEnableFormat\":false,\"key\":\"Field6663\",\"cSubId\":\"GT40110AT28\",\"controlled\":true,\"_actions\":{\"onSubmit\":[{\"action\":\"cmdSearch\",\"type\":\"command\",\"event\":\"onSubmit\"}]},\"defaultValue\":\"\",\"disabled\":\"\",\"term\":{\"displayName\":\"文本\",\"name\":\"wenben\"},\"placeholder\":\"编码/名称/型号规格/助记...\",\"value\":\"\",\"maxLength\":\"\",\"needClear\":false}",
            "needReduce": false
        }, {
            "name": "mActionList",
            "event": "submit",
        ...
        if (billType == 'editvoucherlist') {
            var girdModelKeys = ["tester0924_1928948274417920"]
            if (girdModelKeys) {
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT40110AT28'] && cb.biz['GT40110AT28']['GT40110AT28_9269a437MobileList_VM_Extend']){
        //   console.info('%c GT40110AT28_9269a437MobileList_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT40110AT28']['GT40110AT28_9269a437MobileList_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT40110AT28/GT40110AT28_9269a437MobileList_VM.Extend.js';
        cb.require('', [extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT40110AT28_9269a437MobileList_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT40110AT28_9269a437MobileList_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
