...
console.info('%c GT48228AT13_67288947MobileArchive_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
if (window && window.__debugger) debugger;
cb.viewmodels.register('GT48228AT13_67288947MobileArchive_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            'wenben': new cb.models.SimpleModel({
                ...
                "bMain": true,
                "cDataSourceName": "GT48228AT13.GT48228AT13.allytpet",
                "cControlType": "input",
                "bVmExclude": 0,
                "multiple": false,
                "iOrder": 10,
            ...
            'a1125meijutest': new cb.models.ListModel({
                "cFieldName": "a1125meijutest",
                "fieldRuntimeState": false,
                "cItemName": "a1125meijutest",
                "cCaption": "1125枚举",
                "cShowCaption": "1125枚举",
                "iBillTplGroupId": 290667,
                "iTplId": 14017,
                ...
                "bEnableFormat": false,
                "key": "Field236891",
                "cExtProps": "{\"mode\":\"tag\",\"isDeleted\":0,\"BASEURL\":\"https://build.yyuap.com/iuap-front\",\"disabled\":false,\"cSourceType\":\"\",\"placeholder\":\"\",\"singleLine\":true,\"canMultiple\":false}",
                "mode": "tag",
                "isDeleted": 0,
            ...
            'a1125meijtst': new cb.models.ListModel({
                "cFieldName": "a1125meijtst",
                "fieldRuntimeState": false,
                "cItemName": "a1125meijtst",
                "cCaption": "1125枚举1",
                "cShowCaption": "1125枚举1",
                "iBillTplGroupId": 290667,
                "iTplId": 14017,
                "iMaxLength": 200,
                "iFieldType": 1,
                ...
                "bEnableFormat": false,
                "key": "Field236892",
                "cExtProps": "{\"mode\":\"tag\",\"isDeleted\":0,\"BASEURL\":\"https://build.yyuap.com/iuap-front\",\"disabled\":false,\"cSourceType\":\"\",\"placeholder\":\"\",\"singleLine\":true,\"canMultiple\":true}",
                "mode": "tag",
                "isDeleted": 0,
                "BASEURL": "https://build.yyuap.com/iuap-front",
                "disabled": false,
            ...
            'workflowbtn': new cb.models.SimpleModel({
                ...
                "bEnableFormat": false,
                "key": "3138",
                "cExtProps": "{\"cSubId\":\"GT48228AT13\",\"buttonType\":\"toolbar-default\",\"size\":\"small\",\"cName\":\"\",\"bShowIt\":true,\"bHidden\":false,\"label\":\"下推\",\"cDataSourceName\":\"GT48228AT13.GT48228AT13.allytpet\",\"cFieldName\":\"\"}",
                "cSubId": "GT48228AT13",
            ...
            'btnSubAbandon_1': new cb.models.SimpleModel({
                ...
                "bEnableFormat": false,
                "key": "494748",
                "cExtProps": "{\"mode\":\"toolbar-default\",\"_actions\":{\"onClick\":[{\"des\":\"关闭子页面\",\"action\":\"closePage\",\"type\":\"front\",\"event\":\"onClick\",\"params\":{\"cGroupCode\":\"allytpet1List\"}}]}}",
                "mode": "toolbar-default",
                "_actions": {
                    "onClick": [{
                        "des": "关闭子页面",
            ...
            'allytpet1List': new cb.models.GridModel({
                "columns": {
                    "wenben": {
                        "cFieldName": "wenben",
                        "fieldRuntimeState": false,
                        ...
                        "bPrintUpCase": false,
                        "bSelfDefine": false,
                        "cTplGroupName": "全类型1子表",
                        "bMain": false,
                        "cDataSourceName": "GT48228AT13.GT48228AT13.allytpet1",
                        "cParentDataSource": "GT48228AT13.GT48228AT13.allytpet",
                        "cControlType": "input",
                        "bVmExclude": 0,
                        "multiple": false,
                        "iOrder": 520,
                    ...
                    "allytpet1Fk": {
                        "cFieldName": "allytpet1Fk",
                        "fieldRuntimeState": false,
                        "cItemName": "allytpet1Fk",
                        "cCaption": "外键",
                        "cShowCaption": "外键",
                        "iBillTplGroupId": 290673,
                        "iTplId": 14017,
        ...
        var girdModelKeys = ["allytpet1List"]
        if (girdModelKeys) {
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT48228AT13'] && cb.biz['GT48228AT13']['GT48228AT13_67288947MobileArchive_VM_Extend']){
        //   console.info('%c GT48228AT13_67288947MobileArchive_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT48228AT13']['GT48228AT13_67288947MobileArchive_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT48228AT13/GT48228AT13_67288947MobileArchive_VM.Extend.js';
        cb.require('developplatform', [extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT48228AT13_67288947MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT48228AT13_67288947MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
