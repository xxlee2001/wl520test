...
console.info('%c GT2190AT8_7784c2a2MobileArchive_VM js init', 'color:green');
cb.viewmodels.register('GT2190AT8_7784c2a2MobileArchive_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            'sys_intboolean': new cb.models.ListModel({
                ...
                "cDefaultValue": "",
                "bPrintUpCase": false,
                "BASEURL": "https://yonbuilder-pre.diwork.com/iuap-front",
                "isExport": true,
                "singleLine": true,
                "bExtend": false,
                "bMustSelect": true,
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT2190AT8'] && cb.biz['GT2190AT8']['GT2190AT8_7784c2a2MobileArchive_VM_Extend']){
        //   console.info('%c GT2190AT8_7784c2a2MobileArchive_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT2190AT8']['GT2190AT8_7784c2a2MobileArchive_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT2190AT8/GT2190AT8_7784c2a2MobileArchive_VM.Extend.js';
        cb.require([extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT2190AT8_7784c2a2MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT2190AT8_7784c2a2MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
