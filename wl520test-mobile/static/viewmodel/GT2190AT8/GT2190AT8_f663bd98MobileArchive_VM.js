...
console.info('%c GT2190AT8_f663bd98MobileArchive_VM js init', 'color:green');
cb.viewmodels.register('GT2190AT8_f663bd98MobileArchive_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            '1597318836475_2': new cb.models.SimpleModel({
                "regRule": "",
                "bEnum": false,
                "defaultValue": "",
                "iBillTplGroupId": 290664,
                "iFieldType": 1,
                ...
                "iTplId": 67,
                "regRuleText": "",
                "cDataSourceName": "GT2190AT8.GT2190AT8.zengbu2",
                "iMaxShowLen": 255,
                "bSplit": false,
                "bHidden": false,
                "disabled": false,
            ...
            '1597310288524_20': new cb.models.SimpleModel({
                "bEnum": false,
                "defaultValue": "",
                "iBillTplGroupId": 290667,
                "iFieldType": 1,
                ...
                "bPrintCaption": true,
                "iTplId": 67,
                "cDataSourceName": "{displayName=增补2, name=zengbu2, id=b1196603-7bf4-45f3-b2b4-63a8516e289c, uri=GT2190AT8.GT2190AT8.zengbu2, primaryKey=id}",
                "iMaxShowLen": 255,
                "bSplit": false,
                "bHidden": false,
                "disabled": false,
            ...
            '1597310285463_17': new cb.models.SimpleModel({
                "bEnum": false,
                "defaultValue": "",
                "emailDataSource": "",
                "iBillTplGroupId": 290667,
            ...
            '1597310278431_5': new cb.models.SimpleModel({
                "bEnum": false,
                "defaultValue": "",
                "iBillTplGroupId": 290667,
                "iFieldType": 1,
            ...
            '1597373692224_2': new cb.models.SimpleModel({
                "regRule": "",
                "bEnum": false,
                "defaultValue": "",
                "iBillTplGroupId": 290667,
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT2190AT8'] && cb.biz['GT2190AT8']['GT2190AT8_f663bd98MobileArchive_VM_Extend']){
        //   console.info('%c GT2190AT8_f663bd98MobileArchive_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT2190AT8']['GT2190AT8_f663bd98MobileArchive_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT2190AT8/GT2190AT8_f663bd98MobileArchive_VM.Extend.js';
        cb.require([extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT2190AT8_f663bd98MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT2190AT8_f663bd98MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
