...
console.info('%c GT16637AT476_1cd6e249MobileArchive_VM js init', 'color:green');
cb.viewmodels.register('GT16637AT476_1cd6e249MobileArchive_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            'compareLogic5': new cb.models.ListModel({
                "bEnum": true,
            ...
            'compareLogic4': new cb.models.ListModel({
                "bEnum": true,
                "iBillTplGroupId": 290667,
                "iFieldType": 1,
                "bVmExclude": 0,
            ...
            'compareLogic3': new cb.models.ListModel({
                "bEnum": true,
                "iBillTplGroupId": 290667,
                "iFieldType": 1,
                "bVmExclude": 0,
            ...
            'compareLogic2': new cb.models.ListModel({
                "bEnum": true,
                "iBillTplGroupId": 290667,
                "iFieldType": 1,
                "bVmExclude": 0,
            ...
            'compareLogic1': new cb.models.ListModel({
                "bEnum": true,
                "iBillTplGroupId": 290667,
                "iFieldType": 1,
                "bVmExclude": 0,
            ...
            'sys_action5': new cb.models.ListModel({
                "bEnum": true,
                "iBillTplGroupId": 290667,
                "iFieldType": 1,
                "bVmExclude": 0,
            ...
            'sys_action4': new cb.models.ListModel({
                "bEnum": true,
                "iBillTplGroupId": 290667,
                "iFieldType": 1,
                "bVmExclude": 0,
            ...
            'sys_action3': new cb.models.ListModel({
                "bEnum": true,
                "iBillTplGroupId": 290667,
                "iFieldType": 1,
                "bVmExclude": 0,
            ...
            'sys_action2': new cb.models.ListModel({
                "bEnum": true,
                "iBillTplGroupId": 290667,
                "iFieldType": 1,
                "bVmExclude": 0,
            ...
            'sys_action1': new cb.models.ListModel({
                "bEnum": true,
                "iBillTplGroupId": 290667,
                "iFieldType": 1,
                "bVmExclude": 0,
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT16637AT476'] && cb.biz['GT16637AT476']['GT16637AT476_1cd6e249MobileArchive_VM_Extend']){
        //   console.info('%c GT16637AT476_1cd6e249MobileArchive_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT16637AT476']['GT16637AT476_1cd6e249MobileArchive_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT16637AT476/GT16637AT476_1cd6e249MobileArchive_VM.Extend.js';
        cb.require([extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT16637AT476_1cd6e249MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT16637AT476_1cd6e249MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
