...
console.info('%c GT44591AT60_555e98e6MobileArchive_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
if (window && window.__debugger) debugger;
cb.viewmodels.register('GT44591AT60_555e98e6MobileArchive_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            'new5': new cb.models.SimpleModel({
                ...
                "bEnableFormat": false,
                "key": "Field219978",
                "cExtProps": "{\"_actions\":{\"onChange\":[{\"scriptId\":\"1b6d0f5257224254864a69908699963d\",\"action\":\"555e98e6MobileArchive_new5_onChange\",\"description\":\"前端函数\",\"type\":\"fun\",\"event\":\"onChange\"}]},\"onChange\":\"new5_onChange\",\"isDeleted\":0,\"formulaDisplay\":\"字段1+字段2\",\"formula\":\"new1+new2\",\"disabled\":false,\"cSourceType\":\"\",\"placeholder\":\"\",\"singleLine\":true,\"canMultiple\":false}",
                "_actions": {
                    "onChange": [{
                        "scriptId": "1b6d0f5257224254864a69908699963d",
                        "action": "555e98e6MobileArchive_new5_onChange",
                        "description": "前端函数",
                        "type": "fun",
                        "event": "onChange"
        ...
        _this.allEvents = [{
            ...
            "cAction": "new5_onChange",
            "isCommandEvent": true,
            "params": "{\"cmdParameter\":\"{\\\"X_ISFUN\\\":\\\"true\\\",\\\"X_ISFRONT\\\":\\\"true\\\"}\",\"cCommand\":\"new5_onChange\",\"cAction\":\"new5_onChange\",\"cParameter\":\"{\\\"X_ISFUN\\\":\\\"true\\\",\\\"X_ISFRONT\\\":\\\"true\\\"}\",\"cFieldName\":\"new5\",\"fieldRuntimeState\":false,\"cItemName\":\"new5\",\"cCaption\":\"字段5\",\"cShowCaption\":\"字段5\",\"iBillTplGroupId\":290667,\"iTplId\":13454,\"iMaxLength\":32,\"iFieldType\":1,\"bEnum\":false,\"bMustSelect\":true,\"bHidden\":false,\"iFunctionType\":0,\"bSplit\":false,\"bExtend\":false,\"iNumPoint\":8,\"bCanModify\":true,\"cSourceType\":\"\",\"iMaxShowLen\":32,\"iColWidth\":0,\"bNeedSum\":false,\"bShowIt\":true,\"bFixed\":true,\"bFilter\":true,\"cDefaultValue\":\"\",\"bIsNull\":true,\"bPrintCaption\":true,\"bJointQuery\":false,\"bPrintUpCase\":false,\"bSelfDefine\":false,\"cTplGroupName\":\"Flex布局\",\"bMain\":true,\"cDataSourceName\":\"GT44591AT60.GT44591AT60.dongzuotet\",\"cControlType\":\"numberwidget\",\"bVmExclude\":0,\"multiple\":false,\"iOrder\":40,\"iSystem\":2,\"authLevel\":3,\"isExport\":true,\"uncopyable\":false,\"iAlign\":1,\"bEnableFormat\":false,\"key\":\"Field219978\",\"cExtProps\":\"{\\\"_actions\\\":{\\\"onChange\\\":[{\\\"scriptId\\\":\\\"1b6d0f5257224254864a69908699963d\\\",\\\"action\\\":\\\"555e98e6MobileArchive_new5_onChange\\\",\\\"description\\\":\\\"前端函数\\\",\\\"type\\\":\\\"fun\\\",\\\"event\\\":\\\"onChange\\\"}]},\\\"onChange\\\":\\\"new5_onChange\\\",\\\"isDeleted\\\":0,\\\"formulaDisplay\\\":\\\"字段1+字段2\\\",\\\"formula\\\":\\\"new1+new2\\\",\\\"disabled\\\":false,\\\"cSourceType\\\":\\\"\\\",\\\"placeholder\\\":\\\"\\\",\\\"singleLine\\\":true,\\\"canMultiple\\\":false}\",\"_actions\":{\"onChange\":[{\"scriptId\":\"1b6d0f5257224254864a69908699963d\",\"action\":\"555e98e6MobileArchive_new5_onChange\",\"description\":\"前端函数\",\"type\":\"fun\",\"event\":\"onChange\"}]},\"isDeleted\":0,\"formulaDisplay\":\"字段1+字段2\",\"formula\":\"new1+new2\",\"disabled\":false,\"placeholder\":\"\",\"singleLine\":true,\"canMultiple\":false}",
            "needReduce": false
        }, {
            "name": "mActionList",
            "event": "fail",
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT44591AT60'] && cb.biz['GT44591AT60']['GT44591AT60_555e98e6MobileArchive_VM_Extend']){
        //   console.info('%c GT44591AT60_555e98e6MobileArchive_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT44591AT60']['GT44591AT60_555e98e6MobileArchive_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT44591AT60/GT44591AT60_555e98e6MobileArchive_VM.Extend.js';
        cb.require('developplatform', [extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT44591AT60_555e98e6MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT44591AT60_555e98e6MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
