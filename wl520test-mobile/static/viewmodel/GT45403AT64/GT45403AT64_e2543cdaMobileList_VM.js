...
console.info('%c GT45403AT64_e2543cdaMobileList_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
if (window && window.__debugger) debugger;
cb.viewmodels.register('GT45403AT64_e2543cdaMobileList_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            '1596088905961_2': new cb.models.SimpleModel({
                ...
                "bMain": true,
                "cDataSourceName": "GT45403AT64.GT45403AT64.qyleixzhidu1112",
                "cControlType": "icon",
                "bVmExclude": 0,
                "iOrder": 10,
                "iSystem": 1,
            ...
            'btnSelectAll': new cb.models.SimpleModel({
                ...
                "bEnableFormat": false,
                "key": "2870",
                "cExtProps": "{\"mode\":\"toolbar-default\",\"cSubId\":\"GT45403AT64\",\"_actions\":{\"onClick\":[{\"des\":\"显示子页面\",\"action\":\"showPage\",\"type\":\"front\",\"event\":\"onClick\",\"params\":{\"cGroupCode\":\"1595488808715_5\"}}]},\"size\":\"small\",\"cName\":\"\",\"bShowIt\":true,\"disabled\":false,\"bHidden\":false,\"cDataSourceName\":\"GT45403AT64.GT45403AT64.qyleixzhidu1112\",\"loading\":false,\"cFieldName\":\"\"}",
            ...
            'btnBatchDelete': new cb.models.SimpleModel({
                ...
                "bEnableFormat": false,
                "key": "2827",
                "cExtProps": "{\"mode\":\"toolbar-primary\",\"cSubId\":\"GT45403AT64\",\"_actions\":{\"onClick\":[{\"action\":\"cmdBatchDelete\",\"event\":\"onClick\",\"type\":\"command\"}]},\"size\":\"small\",\"cName\":\"\",\"bShowIt\":true,\"disabled\":false,\"bHidden\":false,\"cDataSourceName\":\"GT45403AT64.GT45403AT64.qyleixzhidu1112\",\"loading\":false,\"cFieldName\":\"\"}",
            ...
            'btnBatchSubmit': new cb.models.SimpleModel({
                ...
                "bEnableFormat": false,
                "key": "2826",
                "cExtProps": "{\"mode\":\"toolbar-default\",\"cSubId\":\"GT45403AT64\",\"_actions\":{\"onClick\":[{\"action\":\"cmdBatchSubmit\",\"event\":\"onClick\",\"type\":\"command\"}]},\"size\":\"small\",\"cName\":\"\",\"bShowIt\":true,\"disabled\":false,\"bHidden\":false,\"cDataSourceName\":\"GT45403AT64.GT45403AT64.qyleixzhidu1112\",\"loading\":false,\"cFieldName\":\"\"}",
                "mode": "toolbar-default",
                "cSubId": "GT45403AT64",
                "_actions": {
                    "onClick": [{
            ...
            'btnSelectAbandon': new cb.models.SimpleModel({
                ...
                "bEnableFormat": false,
                "key": "3026",
                "cExtProps": "{\"mode\":\"toolbar-default\",\"cSubId\":\"GT45403AT64\",\"_actions\":{\"onClick\":[{\"des\":\"关闭子页面\",\"action\":\"closePage\",\"type\":\"front\",\"event\":\"onClick\",\"params\":{}}]},\"size\":\"small\",\"cName\":\"\",\"bShowIt\":true,\"disabled\":false,\"bHidden\":false,\"cDataSourceName\":\"GT45403AT64.GT45403AT64.qyleixzhidu1112\",\"loading\":false,\"cFieldName\":\"\"}",
                "mode": "toolbar-default",
                "cSubId": "GT45403AT64",
                "_actions": {
                    "onClick": [{
            ...
            'workflowbtn': new cb.models.SimpleModel({
                ...
                "bEnableFormat": false,
                "key": "3165",
                "cExtProps": "{\"cSubId\":\"GT45403AT64\",\"buttonType\":\"toolbar-default\",\"size\":\"small\",\"cName\":\"\",\"bShowIt\":true,\"bHidden\":false,\"label\":\"下推\",\"cDataSourceName\":\"GT45403AT64.GT45403AT64.qyleixzhidu1112\",\"cFieldName\":\"\"}",
                "cSubId": "GT45403AT64",
            ...
            'btnDetailSubmit': new cb.models.SimpleModel({
                ...
                "bEnableFormat": false,
                "key": "3027",
                "cExtProps": "{\"mode\":\"toolbar-primary\",\"cSubId\":\"GT45403AT64\",\"_actions\":{\"onClick\":[{\"action\":\"cmdBatchSubmit\",\"type\":\"command\",\"event\":\"onClick\"}]},\"size\":\"small\",\"cName\":\"\",\"bShowIt\":true,\"disabled\":false,\"bHidden\":false,\"cDataSourceName\":\"GT45403AT64.GT45403AT64.qyleixzhidu1112\",\"loading\":false,\"cFieldName\":\"\"}",
                "mode": "toolbar-primary",
                "cSubId": "GT45403AT64",
                "_actions": {
                    "onClick": [{
            ...
            'btnDetailDelete': new cb.models.SimpleModel({
                ...
                "bEnableFormat": false,
                "key": "3028",
                "cExtProps": "{\"mode\":\"toolbar-default\",\"cSubId\":\"GT45403AT64\",\"_actions\":{\"onClick\":[{\"action\":\"cmdBatchDelete\",\"type\":\"command\",\"event\":\"onClick\"}]},\"size\":\"small\",\"cName\":\"\",\"bShowIt\":true,\"disabled\":false,\"bHidden\":false,\"cDataSourceName\":\"GT45403AT64.GT45403AT64.qyleixzhidu1112\",\"loading\":false,\"cFieldName\":\"\"}",
                "mode": "toolbar-default",
                "cSubId": "GT45403AT64",
                "_actions": {
                    "onClick": [{
            ...
            'qyleixzhidu1112_1997033748074752': new cb.models.GridModel({
                "columns": {
                    "1596088905961_2": {
                        "cFieldName": "",
                        "fieldRuntimeState": false,
        ...
        if (billType == 'editvoucherlist') {
            var girdModelKeys = ["qyleixzhidu1112_1997033748074752"]
            if (girdModelKeys) {
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT45403AT64'] && cb.biz['GT45403AT64']['GT45403AT64_e2543cdaMobileList_VM_Extend']){
        //   console.info('%c GT45403AT64_e2543cdaMobileList_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT45403AT64']['GT45403AT64_e2543cdaMobileList_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT45403AT64/GT45403AT64_e2543cdaMobileList_VM.Extend.js';
        cb.require('developplatform', [extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT45403AT64_e2543cdaMobileList_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT45403AT64_e2543cdaMobileList_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
