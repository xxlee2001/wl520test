...
console.info('%c GT45403AT64_69f5215fMobileList_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
if (window && window.__debugger) debugger;
cb.viewmodels.register('GT45403AT64_69f5215fMobileList_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            'qyleixzhidu111_2000811900375296': new cb.models.GridModel({
                "columns": {
                    "1596088905961_2": {
                        "cFieldName": "",
                        "fieldRuntimeState": false,
            ...
            'lianxifangshi': new cb.models.SimpleModel({
                ...
                "enterDirection": 4,
                "bEnableFormat": false,
                "cExtProps": "{\"cSubId\":\"GT45403AT64\",\"rightIcon\":\"\",\"textAlign\":\"left\",\"textClamp\":0,\"leftIcon\":\"\",\"style\":{\"paddingBottom\":\"0.02rem\",\"color\":\"#888888\",\"width\":\"1.12rem\",\"fontSize\":\"0.26rem\",\"paddingTop\":\"0.02rem\",\"marginLeft\":\"0.24rem\"},\"textLangth\":0}",
                "rightIcon": "",
                "textAlign": "left",
                "textClamp": 0,
                "leftIcon": "",
            ...
            'dingwei': new cb.models.SimpleModel({
                ...
                "enterDirection": 4,
                "bEnableFormat": false,
                "cExtProps": "{\"cSubId\":\"GT45403AT64\",\"rightIcon\":\"\",\"textAlign\":\"left\",\"textClamp\":0,\"leftIcon\":\"\",\"style\":{\"paddingBottom\":\"0.02rem\",\"color\":\"hsl(0, 0%, 53.3%)\",\"width\":\"1.2rem\",\"fontSize\":\"0.24rem\",\"paddingTop\":\"0.02rem\",\"marginLeft\":\"0.24rem\"},\"textLangth\":0}",
                "rightIcon": "",
                "textAlign": "left",
                "textClamp": 0,
                "leftIcon": "",
        ...
        if (billType == 'editvoucherlist') {
            var girdModelKeys = ["qyleixzhidu111_2000811900375296"]
            if (girdModelKeys) {
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT45403AT64'] && cb.biz['GT45403AT64']['GT45403AT64_69f5215fMobileList_VM_Extend']){
        //   console.info('%c GT45403AT64_69f5215fMobileList_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT45403AT64']['GT45403AT64_69f5215fMobileList_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT45403AT64/GT45403AT64_69f5215fMobileList_VM.Extend.js';
        cb.require('developplatform', [extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT45403AT64_69f5215fMobileList_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT45403AT64_69f5215fMobileList_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
