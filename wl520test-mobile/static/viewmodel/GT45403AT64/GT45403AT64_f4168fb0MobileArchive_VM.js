...
console.info('%c GT45403AT64_f4168fb0MobileArchive_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
if (window && window.__debugger) debugger;
cb.viewmodels.register('GT45403AT64_f4168fb0MobileArchive_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            'wenben': new cb.models.SimpleModel({
                ...
                "bMain": true,
                "cDataSourceName": "GT45403AT64.GT45403AT64.zhuzixinmu",
                "cControlType": "input",
                "bVmExclude": 0,
                "multiple": false,
                "iOrder": 10,
            ...
            'tupian': new cb.models.SimpleModel({
                ...
                "bEnableFormat": false,
                "key": "Field217107",
                "cExtProps": "{\"cSubId\":\"\",\"size\":\"md\",\"borderRadius\":0,\"label\":\"\",\"showLabel\":false,\"url\":\"\"}",
                "cSubId": "",
                "size": "md",
                "borderRadius": 0,
                "label": "",
            ...
            'workflowbtn': new cb.models.SimpleModel({
                ...
                "bEnableFormat": false,
                "key": "3138",
                "cExtProps": "{\"cSubId\":\"GT45403AT64\",\"buttonType\":\"toolbar-default\",\"size\":\"small\",\"cName\":\"\",\"bShowIt\":true,\"bHidden\":false,\"label\":\"下推\",\"cDataSourceName\":\"GT45403AT64.GT45403AT64.zhuzixinmu\",\"cFieldName\":\"\"}",
                "cSubId": "GT45403AT64",
            ...
            'btnSubAbandon_1': new cb.models.SimpleModel({
                ...
                "bEnableFormat": false,
                "key": "494748",
                "cExtProps": "{\"mode\":\"toolbar-default\",\"_actions\":{\"onClick\":[{\"des\":\"关闭子页面\",\"action\":\"closePage\",\"type\":\"front\",\"event\":\"onClick\",\"params\":{\"cGroupCode\":\"zizcintetList\"}}]}}",
                "mode": "toolbar-default",
                "_actions": {
                    "onClick": [{
                        "des": "关闭子页面",
            ...
            'zizcintetList': new cb.models.GridModel({
                "columns": {
                    "tupian": {
                        "cFieldName": "tupian",
                        "fieldRuntimeState": false,
                        ...
                        "cTplGroupName": "流式布局",
                        "bMain": false,
                        "cDataSourceName": "GT45403AT64.GT45403AT64.zizcintet",
                        "cParentDataSource": "GT45403AT64.GT45403AT64.zhuzixinmu",
                        "cControlType": "picture",
                        "bVmExclude": 0,
                        "iOrder": 320,
                        "iSystem": 1,
                    ...
                    "dingwei": {
                        ...
                        "bEnableFormat": false,
                        "key": "Field231946",
                        "cExtProps": "{\"cSubId\":\"\",\"isReadonly\":false,\"showExtraLabelIcon\":false,\"subLabel\":\"\",\"targetRange\":1000,\"targetLat\":\"40.068928\",\"singleLineCenter\":false,\"targetLng\":\"116.236847\",\"splitLine\":true,\"showType\":\"address\",\"setTarget\":false,\"disabled\":false,\"showIcon\":true}",
                        "cSubId": "",
                        "isReadonly": false,
                    ...
                    "zizcintetFk": {
                        "cFieldName": "zizcintetFk",
                        "fieldRuntimeState": false,
                        "cItemName": "zizcintetFk",
                        "cCaption": "外键",
                        "cShowCaption": "外键",
                        "iBillTplGroupId": 290673,
                        "iTplId": 13344,
        ...
        var girdModelKeys = ["zizcintetList"]
        if (girdModelKeys) {
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT45403AT64'] && cb.biz['GT45403AT64']['GT45403AT64_f4168fb0MobileArchive_VM_Extend']){
        //   console.info('%c GT45403AT64_f4168fb0MobileArchive_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT45403AT64']['GT45403AT64_f4168fb0MobileArchive_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT45403AT64/GT45403AT64_f4168fb0MobileArchive_VM.Extend.js';
        cb.require('developplatform', [extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT45403AT64_f4168fb0MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT45403AT64_f4168fb0MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
