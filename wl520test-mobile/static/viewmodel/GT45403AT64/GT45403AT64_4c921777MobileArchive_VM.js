...
console.info('%c GT45403AT64_4c921777MobileArchive_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
if (window && window.__debugger) debugger;
cb.viewmodels.register('GT45403AT64_4c921777MobileArchive_VM', function(modelType) {
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT45403AT64'] && cb.biz['GT45403AT64']['GT45403AT64_4c921777MobileArchive_VM_Extend']){
        //   console.info('%c GT45403AT64_4c921777MobileArchive_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT45403AT64']['GT45403AT64_4c921777MobileArchive_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT45403AT64/GT45403AT64_4c921777MobileArchive_VM.Extend.js';
        cb.require('developplatform', [extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT45403AT64_4c921777MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT45403AT64_4c921777MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
