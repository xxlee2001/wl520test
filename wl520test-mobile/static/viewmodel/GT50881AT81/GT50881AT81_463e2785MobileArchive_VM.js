...
console.info('%c GT50881AT81_463e2785MobileArchive_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
if (window && window.__debugger) debugger;
cb.viewmodels.register('GT50881AT81_463e2785MobileArchive_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            'btnAddRow_2': new cb.models.SimpleModel({
                ...
                "iStyle": 0,
                "cCommand": "cmdAddRow",
                "childrenField": "cesaaasdf222List",
                "bVmExclude": 0,
                "iOrder": 0,
                "uncopyable": false,
                "bEnableFormat": false,
            ...
            'btnSubAbandon_1': new cb.models.SimpleModel({
                ...
                "bEnableFormat": false,
                "key": "494748",
                "cExtProps": "{\"mode\":\"toolbar-default\",\"_actions\":{\"onClick\":[{\"des\":\"关闭子页面\",\"action\":\"closePage\",\"type\":\"front\",\"event\":\"onClick\",\"params\":{\"cGroupCode\":\"cesaaasdf11List\"}}]}}",
                "mode": "toolbar-default",
                "_actions": {
                    "onClick": [{
                        "des": "关闭子页面",
            ...
            'btnSubAbandon_2': new cb.models.SimpleModel({
                ...
                "bEnableFormat": false,
                "key": "494748",
                "cExtProps": "{\"mode\":\"toolbar-default\",\"_actions\":{\"onClick\":[{\"des\":\"关闭子页面\",\"action\":\"closePage\",\"type\":\"front\",\"event\":\"onClick\",\"params\":{\"cGroupCode\":\"cesaaasdf222List\"}}]}}",
                "mode": "toolbar-default",
                "_actions": {
                    "onClick": [{
                        "des": "关闭子页面",
            ...
            'cesaaasdf11List': new cb.models.GridModel({
                "columns": {
                    "wenben": {
                        "cFieldName": "wenben",
                        "fieldRuntimeState": false,
                        ...
                        "bPrintUpCase": false,
                        "bSelfDefine": false,
                        "cTplGroupName": "cesaaasdf111",
                        "bMain": false,
                        "cDataSourceName": "GT50881AT81.GT50881AT81.cesaaasdf11",
                        "cParentDataSource": "GT50881AT81.GT50881AT81.cesaaasdf",
                        "cControlType": "input",
                        "bVmExclude": 0,
                        "multiple": false,
                        "iOrder": 340,
                    ...
                    "cesaaasdf11Fk": {
                        "cFieldName": "cesaaasdf11Fk",
                        "fieldRuntimeState": false,
                        "cItemName": "cesaaasdf11Fk",
                        "cCaption": "外键",
                        "cShowCaption": "外键",
                        "iBillTplGroupId": 290673,
                        "iTplId": 14564,
                ...
                "pagination": false,
                "cShowCaption": "cesaaasdf111",
                "primaryKey": "id"
            }),


            'cesaaasdf222List': new cb.models.GridModel({
                "columns": {
                    "wenben": {
                        "cFieldName": "wenben",
                        "fieldRuntimeState": false,
                        ...
                        "bPrintUpCase": false,
                        "bSelfDefine": false,
                        "cTplGroupName": "cesaaasdf222",
                        "bMain": false,
                        "cDataSourceName": "GT50881AT81.GT50881AT81.cesaaasdf222",
                        "cParentDataSource": "GT50881AT81.GT50881AT81.cesaaasdf",
                        "cControlType": "input",
                        "bVmExclude": 0,
                        "multiple": false,
                    ...
                    "cesaaasdf222Fk": {
                        "cFieldName": "cesaaasdf222Fk",
                        "fieldRuntimeState": false,
                        "cItemName": "cesaaasdf222Fk",
                        "cCaption": "外键",
                        "cShowCaption": "外键",
                        "iBillTplGroupId": 290673,
                        "iTplId": 14564,
        ...
        var girdModelKeys = ["cesaaasdf11List", "cesaaasdf222List"]
        if (girdModelKeys) {
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT50881AT81'] && cb.biz['GT50881AT81']['GT50881AT81_463e2785MobileArchive_VM_Extend']){
        //   console.info('%c GT50881AT81_463e2785MobileArchive_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT50881AT81']['GT50881AT81_463e2785MobileArchive_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT50881AT81/GT50881AT81_463e2785MobileArchive_VM.Extend.js';
        cb.require('developplatform', [extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT50881AT81_463e2785MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT50881AT81_463e2785MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
