...
console.info('%c GT18089AT510_81430d55MobileArchive_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
console.info('%c GT18089AT510_81430d55MobileArchive_VM js init', 'color:green');
cb.viewmodels.register('GT18089AT510_81430d55MobileArchive_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            '1597807094529_2': new cb.models.SimpleModel({
                "bEnum": false,
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT18089AT510'] && cb.biz['GT18089AT510']['GT18089AT510_81430d55MobileArchive_VM_Extend']){
        //   console.info('%c GT18089AT510_81430d55MobileArchive_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT18089AT510']['GT18089AT510_81430d55MobileArchive_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT18089AT510/GT18089AT510_81430d55MobileArchive_VM.Extend.js';
        cb.require([extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT18089AT510_81430d55MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT18089AT510_81430d55MobileArchive_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
