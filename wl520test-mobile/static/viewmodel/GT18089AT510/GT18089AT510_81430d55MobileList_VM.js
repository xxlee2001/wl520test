...
console.info('%c GT18089AT510_81430d55MobileList_VM js init, yon can debug it by setting the [window.__debugger = true]', 'color:steelblue');
console.info('%c GT18089AT510_81430d55MobileList_VM js init', 'color:green');
cb.viewmodels.register('GT18089AT510_81430d55MobileList_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            '1596088905961_2': new cb.models.SimpleModel({
                ...
                "color": "#0d0c0c",
                "icon": "icon-filter",
                "cDataSourceName": "GT18089AT510.GT18089AT510.zenbugcanz001",
                "iMaxShowLen": 255,
                "bSplit": false,
                "bHidden": false,
                "iOrder": 0,
            ...
            'zenbugcanz001_1876832739234048': new cb.models.GridModel({
                "columns": {
                    "1596088905961_2": {
                        "bEnum": false,
                        "iBillTplGroupId": 290685,
                    ...
                    "BaseRegionVO_name": {
                        ...
                        "metaDataField": {
                            ...
                            "dataType": {
                                ...
                                "name": "BaseRegionVO",
                                "metaType": "Class",
                                "id": "95577e23-979f-4f09-a629-61fea93e576d",
                                "uri": "bd.region.BaseRegionVO"
                            },
                            "name": "BaseRegionVO"
                        },
                        "bSplit": false,
        ...
        _this.allEvents = [{
            ...
            "params": "{\"bEnum\":false,\"defaultValue\":\"\",\"iBillTplGroupId\":10362,\"iFieldType\":1,\"bVmExclude\":0,\"cTplGroupName\":\"流式布局\",\"iSystem\":1,\"bCanModify\":true,\"bPrintUpCase\":false,\"isExport\":true,\"bExtend\":false,\"bMustSelect\":true,\"bMain\":true,\"bEnableFormat\":false,\"cControlType\":\"search\",\"bShowIt\":true,\"bJointQuery\":false,\"cItemName\":\"mSearch\",\"cFieldName\":\"\",\"authLevel\":3,\"uncopyable\":false,\"maxLength\":\"\",\"cCaption\":\"搜索\",\"bPrintCaption\":true,\"iTplId\":1238,\"cDataSourceName\":\"GT18089AT510.GT18089AT510.zenbugcanz001\",\"iMaxShowLen\":255,\"bSplit\":false,\"bHidden\":false,\"disabled\":\"\",\"term\":\"\",\"placeholder\":\"编码/名称/型号规格/助记...\",\"value\":\"\",\"iOrder\":0,\"key\":\"Field6663\",\"cSubId\":\"GT18089AT510\",\"bNeedSum\":false,\"cShowCaption\":\"搜索\",\"bFilter\":true,\"iAlign\":1,\"controlled\":false,\"_actions\":{\"onSubmit\":[{\"action\":\"cmdSearch\",\"type\":\"command\",\"event\":\"onSubmit\"}]},\"bSelfDefine\":false,\"bIsNull\":true,\"needClear\":false}",
            "needReduce": false
        }, {
            "name": "mActionList",
            "event": "submit",
        ...
        if (billType == 'editvoucherlist') {
            var girdModelKeys = ["zenbugcanz001_1876832739234048"]
            if (girdModelKeys) {
    ...
    model.prototype.initData = function() {
        // if(cb.biz['GT18089AT510'] && cb.biz['GT18089AT510']['GT18089AT510_81430d55MobileList_VM_Extend']){
        //   console.info('%c GT18089AT510_81430d55MobileList_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['GT18089AT510']['GT18089AT510_81430d55MobileList_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'GT18089AT510/GT18089AT510_81430d55MobileList_VM.Extend.js';
        cb.require([extendFile], function(extend) {
            if (extend && extend.doAction) {
                ...
                console.error('%c extendVmName-->GT18089AT510_81430d55MobileList_VM_Extend', 'font-size:12pt;color:#860786')
            }
            self.execute('extendReady', self);
        }, function(error) {
            console.info('%c 未找到  ' + extendFile, 'font-size:12pt;color:#860786');
            console.info('%c extendVmName-->GT18089AT510_81430d55MobileList_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
