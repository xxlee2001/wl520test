...
import com.yonyou.iuap.ucf.dynamicds.ds.DataSourceUtils;
...
public class DataSourceConfig {
    ...
    public javax.sql.DataSource jdbcDataSource (@Qualifier("jdbcDataSource_real") DataSource jdbcDataSource_real){
        return DataSourceUtils.getDataSourceByDecorator(jdbcDataSource_real);
    }
     ...
     * @return
     */
    @Bean(destroyMethod = "close",name = "jdbcDataSource_real")
    public DataSource jdbcDataSource_real (DataSourceConfig dataSourceConfig){
        ...
        dataSource.setPassword(dataSourceConfig.getJdbcAcn());
    ...
    public String getJdbcAcn() {
        return jdbcAcn;
    }

    public void setJdbcPassword(String jdbcPassword) {
        this.jdbcAcn = jdbcPassword;
    }
