...
import org.imeta.spring.tpl.builder.DomainBuildService;
...
public class DomainBuildTest {
	...
	public void test() throws Exception {
		...
		// 如果只想生成某些代码文件，请使用具体组件，使用逗号分割，例如：rm.*,aa.product
		String appNames = "bd.staff";
		CodeGenerateService service = context.getBean(DomainBuildService.class);
