...
(function (root, factory) {
   ...
   */
  var Constructor = function (selector, options, scroller) {

    if (!scroller ||
      !scroller.closest('body')) {
        scroller = window;
    }
    ...
    publicAPIs.destroy = function () {
      ...
      scroller.removeEventListener('scroll', scrollHandler, false);
      if (settings.reflow) {
    ...
    publicAPIs.init = function (options) {
      ...
      scroller.addEventListener('scroll', scrollHandler, false);
      if (settings.reflow) {
